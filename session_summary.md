...
- Production was intentionally not deployed because the explicit “all checks OK” gate was not met. No production issue was introduced; production remains on its previous deployment. A separate follow-up should investigate mobile listening/shadowing TBT and the remaining preview Admin long task before promotion.
