"""Generate Tainguyen/cae-Reading-test1/exam.json from Sample Paper 1 + answer key."""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
OUT = ROOT / "Tainguyen" / "cae-Reading-test1" / "exam.json"

MC_OPTS = lambda labels: [{"id": k, "label": v} for k, v in labels]
LETTER_OPTS = lambda n: [{"id": chr(65 + i), "label": chr(65 + i)} for i in range(n)]


def mc_gap(n, options, answer, explanation):
    return {
        "number": n,
        "type": "multiple-choice",
        "prompt": f"Gap ({n})",
        "options": MC_OPTS(options),
        "answer": answer.lower(),
        "explanation": explanation,
    }


def gap(n, answer, explanation, prompt=None):
    return {
        "number": n,
        "type": "gap-fill",
...
def word_form(n, stem, answer, explanation):
    return {
        "number": n,
        "type": "gap-fill",
        "prompt": f"Gap ({n}) — {stem}",
...
def transform(n, prompt, answer, explanation):
    return {
        "number": n,
        "type": "gap-fill",
        "prompt": prompt,
...
def mc_reading(n, prompt, options, answer, explanation):
    return {
        "number": n,
        "type": "multiple-choice",
        "prompt": prompt,
...
def match_feature(n, prompt, option_count, answer, explanation):
    return {
        "number": n,
        "type": "matching-features",
        "prompt": prompt,
        "options": LETTER_OPTS(option_count),
        "answer": answer.lower(),
        "explanation": explanation,
    }
...
exam = {
    "version": 1,
    "title": "CAE C1 Reading — Test 1",
    "durationMinutes": 90,
    "bandHint": "C1 Advanced Reading & Use of English",
    "examTrack": "cambridge",
    "cambridgeLevel": "c1",
    "parts": [
        {
            ...
            "passageTitle": "Part 1 — Studying black bears",
            "passage": [
                {"text": "Studying black bears"},
                {
                    "text": (
                        "After years studying North America's black bears in the (0) …….. way, wildlife biologist Luke "
                        "Robertson felt no closer to understanding the creatures. He realised that he had to (1) ........ "
                        "their trust. Abandoning scientific detachment, he took the daring step of forming relationships with the "
                ...
                },
                {
                    "text": (
                        ...
                        "(7) …….. about their feelings for him. It is clear that their interest in him does not (8) ........... "
            ...
            "questionGroups": [
                {
                    "range": "Questions 1–8",
                    "instruction": "For questions 1–8, read the text and choose the answer (A, B, C or D) which best fits each gap.",
                    "type": "multiple-choice",
                    "questions": [
                        mc_gap(1, [("A", "catch"), ("B", "win"), ("C", "achieve"), ("D", "receive")], "b", "win their trust"),
                        mc_gap(2, [("A", "perception"), ("B", "awareness"), ("C", "insight"), ("D", "vision")], "c", "insight into behaviour"),
                        mc_gap(3, [("A", "Opposite"), ("B", "Opposed"), ("C", "Contrary"), ("D", "Contradictory")], "c", "Contrary to popular belief"),
                        mc_gap(4, [("A", "care"), ("B", "bother"), ("C", "desire"), ("D", "hope")], "a", "do not care as much for fruit"),
                        mc_gap(5, [("A", "concludes"), ("B", "disputes"), ("C", "reasons"), ("D", "argues")], "b", "disputes claims they are ferocious"),
                        mc_gap(6, [("A", "misguided"), ("B", "misled"), ("C", "misdirected"), ("D", "misinformed")], "b", "should not be misled"),
                        mc_gap(7, [("A", "error"), ("B", "doubt"), ("C", "illusion"), ("D", "impression")], "c", "under no illusion"),
                        mc_gap(8, [("A", "expand"), ("B", "spread"), ("C", "widen"), ("D", "extend")], "d", "does not extend beyond the food"),
                    ],
                }
            ],
        },
            ...
            "passage": [
                ...
                },
                {
                    "text": (
                        ...
                        "we are programmed for language from the moment of birth. In (11) …….. words, language came about as a "
            ...
            "questionGroups": [
                {
                    ...
                    "instruction": "For questions 9–16, read the text and write ONE word for each gap.",
                    "type": "gap-fill",
                    "questions": [
                        gap(9, "because", "because of the manner…"),
                        gap(10, "such", "in such a way"),
                        gap(11, "other", "in other words"),
                        gap(12, "could", "may/might/could well be"),
                        gap(13, "despite", "despite this"),
                        gap(14, "if", "if/when/whenever children are isolated"),
                        gap(15, "nothing", "nothing/little else"),
                        gap(16, "in", "in isolation"),
                    ],
                }
            ],
        },
        {
            ...
            "passage": [
                ...
                {
                    "text": (
                        "What are the abilities that a (0) …….. sports person needs? To guarantee that opponents can be "
                        "(17) …….. , speed, stamina and agility are essential, not to mention outstanding natural talent. Both a "
                        "rigorous and comprehensive (18) …….. regime and a highly nutritious diet are vital for top-level performance. "
                        "It is carbohydrates, rather than proteins and fat, that provide athletes with the (19) …….. they need to "
                        "compete. This means that pasta is more (20) …….. than eggs or meat. Such a diet enables them to move very "
                        "energetically when required. Failure to follow a sensible diet can result in the (21) …….. to maintain stamina."
                    )
                },
                {
                    "text": (
                        "Regular training to increase muscular (22) …….. is also a vital part of a professional's regime, and this is "
                        "(23) …….. done by exercising with weights. Sports people are prone to injury but a quality training regime "
                        "can ensure that the (24) …….. of these can be minimised."
                    )
                },
                {"text": "Word stems: PROFESSION · COME · FIT · ENDURE · BENEFIT · ABLE · STRONG · TYPE · SEVERE"},
            ],
            "questionGroups": [
                {
                    ...
                    "type": "gap-fill",
                    "questions": [
                        word_form(17, "COME", "overcome", "opponents can be overcome"),
                        word_form(18, "FIT", "fitness", "comprehensive fitness regime"),
                        word_form(19, "ENDURE", "endurance", "provide athletes with endurance"),
                        word_form(20, "BENEFIT", "beneficial", "pasta is more beneficial"),
                        word_form(21, "ABLE", "inability", "inability to maintain stamina"),
                        word_form(22, "STRONG", "strength", "muscular strength"),
                        word_form(23, "TYPE", "typically", "typically done by exercising"),
                        word_form(24, "SEVERE", "severity", "severity of injuries minimised"),
                    ],
                }
            ],
        },
            ...
            "passage": [
                {
                    "text": (
                        ...
                        "using the word given. Use between three and six words, including the word given."
                    )
                }
            ],
            "questionGroups": [
            ...
            "passage": [
                ...
                },
                {
                    "text": (
                        ...
                        "onto the images, objects and monuments of past centuries. Our judgements and values are not those of "
                        "previous societies (and no doubt they will change again in the future). For the writer-historian looking at the definitions "
            ...
            "questionGroups": [
                {
                    ...
                    "instruction": "For questions 31–36, choose the answer (A, B, C or D) which you think fits best according to the text.",
                    "type": "multiple-choice",
                    "questions": [
                        mc_reading(
                            31,
                            ...
                            "c",
                            "Popular books dismiss colour perception as universal — clutter bibliography.",
                        ),
                        mc_reading(
                            32,
                            ...
                            "a",
                            "Documentation and preservation — colours altered, wrong light, B&W photos.",
                        ),
                        mc_reading(
                            33,
                            ...
                            "c",
                            "Methodology — grapple with many factors at once; need analytical model.",
                        ),
                        mc_reading(
                            34,
                            ...
                            "d",
                            "Philosophical — danger of anachronism projecting modern colour concepts.",
                        ),
                        mc_reading(
                            35,
                            ...
                            "d",
                            "Gaps remain in history of colour in images/artworks.",
                        ),
                        mc_reading(
                            36,
                            ...
                            "c",
                            "Researchers select supporting facts — poor objectivity.",
                        ),
                    ],
                }
            ],
        ...
        {
            "partNumber": 6,
            "rangeLabel": "Questions 37–40",
            "passageTitle": "Part 6 — The Architecture of Happiness",
            "passage": [
                {"text": "The Architecture of Happiness"},
                {"text": "Four reviewers comment on philosopher Alain De Botton's book"},
                {
                    "label": "A",
                    "text": (
            ...
            "questionGroups": [
                {
                    ...
                    "questions": [
                        match_feature(
                            ...
                            4,
                            "b",
                            "Reviewer B — needed help from earlier authors.",
                        ),
                        match_feature(
                            38,
                            ...
                            4,
                            "c",
                            "Reviewer C — professionals should read it.",
                        ),
                        match_feature(
                            39,
                            ...
                            4,
                            "a",
                            "Reviewer A — architects don't talk about emotion.",
                        ),
                        match_feature(
                            40,
                            ...
                            4,
                            "b",
                            "Reviewer B — extraordinary claims vs C's not particularly new.",
                        ),
                    ],
                }
            ],
            ...
            "passage": [
                {"text": "Scottish Wildcat"},
                {
                    "text": (
                        ...
                        "coiled spring ready to unleash some unknown fury."
                    )
                },
                {"text": "(41) ........"},
                {
                    "text": (
                        ...
                        "in some cases up to seven kilos, the same as a typical male fox. The coat pattern is "
                        "superficially similar to a domestic tabby cat but it is all stripes and no spots. The tail is thicker "
                        "and blunter, with three to five black rings. The animal has an altogether heavier look."
                    )
                },
                {
                    "text": (
                        "The Scottish wildcat was originally distinguished as a separate subspecies in 1912, but it is now generally "
                        "recognised that there is little difference between the Scottish and other European populations. According to "
                        "an excellent report on the wildcat printed in 1991, the animals originally occurred in a variety of habitats "
                        "throughout Europe."
                    )
                },
                {"text": "(42) ........"},
                {
                    "text": (
                        ...
                        "landowners for hunting, that the wildcat became a nuisance and its rapid decline really "
                ...
                {"text": "(43) ........"},
                {
                    "text": (
                        ...
                        "western Scotland. This is a cause for real concern, given that the animals in these areas "
                        "have less contact with domestic cats and are therefore purer."
                    )
                },
                {"text": "(44) ........"},
                {
                    "text": (
                        ...
                        "originates from the selective nature of the examination process by the British Natural "
                        "History Museum at the start of the century, and this has been used as the type-definition for "
                        "the animal ever since. Animals that did not conform to that large blunt-tailed 'tabby' "
                        "description were discarded as not being wildcats. In other words, an artificial collection "
                        "of specimens was built up, exhibiting the features considered typical of the wildcat. "
                        "The current research aims to resolve this potential problem. It is attempting to find out "
                        "whether there are any physical features which characterise the so-called wild-living cats."
                    )
                },
                {"text": "(45) ........"},
                {
                ...
                {
                    "text": (
                        "Rabbits are a favourite prey, and some of the best areas to see wildcats are at rabbit "
                        "warrens close to the forest and moorland edge. Mice, small birds and even insects also form a "
                        "large part of the diet, and the animal may occasionally take young deer. "
                        "The wildcat is one of the Scottish Highlands' most exciting animals. Catch a glimpse of one "
                ...
                {"text": "Paragraphs"},
                {
                    "label": "A",
                    "text": (
                        "The recruitment of men to the armed forces during the conflict in Europe from 1914 to 1918 meant "
                        "there was very little persecution, since gamekeepers went off to fight. As the number of gamekeepers decreased, "
                        "the wildcat began to increase its range, recolonising many of its former haunts. Extinction was narrowly averted."
                    ),
                },
                {
                    "label": "B",
                    "text": (
                        "The wildcat waits for a while in rapt concentration, ears twitching and eyes watching, seeing everything and "
                        "hearing everything, trying to detect the tell-tale movement of a vole or a mouse. But there is nothing, and in "
                        "another leap he disappears into the gloom."
                    ),
                },
                {
                    "label": "C",
                    "text": (
                        "The results, which are expected shortly, will be fascinating. But anyone who has seen a wildcat will be in little doubt "
                        "that there is indeed a unique and distinctive animal living in the Scottish Highlands, whatever his background."
                    ),
                },
                {
                    "label": "D",
                    "text": (
                        "They probably used deciduous and coniferous woodland for shelter, particularly in winter, and hunted over "
                        "more open areas such as forest edge, open woodland, thickets and scrub, grassy areas and marsh. The wildcat "
                        "was probably driven into more mountainous areas by a combination of deforestation and persecution."
                    ),
                },
                {
                    "label": "E",
                    "text": (
                        "As the animals emerge, their curiosity is aroused by every movement and rustle in the vegetation. Later they will "
                        "accompany their mother on hunting trips, learning quickly, and soon become adept hunters themselves."
                    ),
                },
                {
                    "label": "F",
                    "text": (
                        "This is what makes many people think that the wildcat is a species in its own right. Research currently being "
                        "undertaken by Scottish Natural Heritage is investigating whether the wildcat really is distinct from its home-living "
                        "cousin, or whether it is nothing more than a wild-living form of the domestic cat."
                    ),
                },
                {
                    "label": "G",
                    "text": (
                        "It is a typical image most folk have of the beast, but it is very much a false one, for the wildcat is little more than a "
                        "bigger version of the domestic cat, and probably shows his anger as often."
                    ),
                },
            ],
            "questionGroups": [
                {
                    ...
                    "instruction": "Six paragraphs have been removed. For each question, choose the correct paragraph (A–G). There is one extra paragraph which you do not need to use.",
                    "type": "matching-features",
                    "features": [
                        {"id": "a", "name": "A"},
                        {"id": "b", "name": "B"},
                    ...
                    "questions": [
                        match_feature(41, "Gap (41)", 7, "g", "False image of snarling wildcat — G"),
                        match_feature(42, "Gap (42)", 7, "d", "Original habitats throughout Europe — D"),
                        match_feature(43, "Gap (43)", 7, "a", "Gamekeepers went to war — recovery — A"),
                        match_feature(44, "Gap (44)", 7, "f", "Distinct from domestic cat research — F"),
                        match_feature(45, "Gap (45)", 7, "c", "Research results expected — C"),
                        match_feature(46, "Gap (46)", 7, "e", "Kittens learning to hunt — E"),
                    ],
                }
            ],
        },
        {
            "partNumber": 8,
            "rangeLabel": "Questions 47–56",
            "passageTitle": "Part 8 — Starting out on your career",
            "passage": [
                {"text": "Starting out on your career"},
                {
                    "text": (
                ...
                },
                {
                    ...
                    "text": (
                        ...
                        "skills. If you find you are not getting past the first interview, ask yourself what is happening. "
                        "Is it a failure to communicate or are there some skills you lack? Once you see patterns "
                        "emerging it will help you decide whether the gaps you have identified can be filled relatively easily. "
                        "If you cannot work out what the mismatch is, get back to the selection panel with more probing questions, "
                        "and find out what you need to do to bring yourself up to the level of qualification that would make you "
                        "more attractive to them: but be careful to make this sound like a genuine request rather than a "
                ...
                },
                {
                    ...
                    "text": (
                        ...
                        "Do not take the comments at face value: think back to the interviews that generated them and "
                        "make a list of where you think the shortfall in your performance lies. With this sort of "
                ...
                },
                {
                    ...
                    "text": (
                        ...
                        "and future employers may question your drive and ambition. Of course, it depends where you are "
                        "aiming. There can be advantages in moving sideways rather than up, if you want to gain "
                        "real depth of knowledge. If you are a graduate, spending five or six years in the same job is "
                        "not too long provided that you take full advantage of the experience. However, do not "
                        "use this as an excuse for apathy. Graduates sometimes fail to take ownership of their "
                        "careers and take the initiative. It is up to you to make the most of what's available within a "
                        "company, and to monitor your progress in case you need to move on. This applies particularly "
                ...
                },
                {
                    "label": "D",
                    "text": (
                        "It is helpful to think through what kind of experience you need to get your dream job and "
                        "it is not a problem to move around to a certain extent. But in the early stages of your career "
                        "you need a definite strategy for reaching your goal, so think about that carefully before "
                        "deciding to move on from your first job. You must cultivate patience to master any role. "
                        "There is no guarantee that you will get adequate training, and research has shown that "
                        "if you do not receive proper help in a new role, it can take 18 months to master it."
                    ),
                },
                {
                    "label": "E",
                    "text": (
                        ...
                        "with no thread running between them. You need to be able to demonstrate the quality of "
                        "your experience to a future employer, and too many moves too quickly can be a bad thing. "
                        "In any company it takes three to six months for a new employee to get up to speed with the "
                        "structure and the culture of the company. From the company's perspective, they will not "
                        "receive any return on the investment in your salary until you have been there for 18 months. "
                        "This is when they begin to get most value from you – you are still fired up and enthusiastic. "
                        "If you leave after six months it has not been a good investment – and may make other "
                        "employers wary."
                    ),
                },
            ],
            "questionGroups": [
                {
                    ...
                    "type": "matching-features",
                    "features": [
                        {"id": "a", "name": "Consultant A"},
                        {"id": "b", "name": "Consultant B"},
                        {"id": "c", "name": "Consultant C"},
                        {"id": "d", "name": "Consultant D"},
                        {"id": "e", "name": "Consultant E"},
                    ],
                    "questions": [
                        match_feature(47, "Keep your final objective in mind when you are planning to change jobs.", 5, "d", "Consultant D — strategy for reaching goal"),
                        match_feature(48, "It takes time to become familiar with the characteristics of a company you have joined.", 5, "e", "Consultant E — 3–6 months to get up to speed"),
                        match_feature(49, "You should demonstrate determination to improve your job prospects.", 5, "c", "Consultant C — take initiative, ownership"),
                        match_feature(50, "Make sure your approach for information is positive in tone.", 5, "a", "Consultant A — genuine request not complaint"),
                        match_feature(51, "It is not certain that you will be given very much support in your job initially.", 5, "d", "Consultant D — no guarantee of adequate training"),
                        match_feature(52, "Stay optimistic in spite of setbacks.", 5, "b", "Consultant B — not too dispirited if turned down"),
                        match_feature(53, "Promotion isn't the only way to increase your expertise.", 5, "c", "Consultant C — moving sideways for depth"),
                        match_feature(54, "Ask for information about your shortcomings.", 5, "a", "Consultant A — probing questions to selection panel"),
                        match_feature(55, "Some information you are given may not give a complete picture.", 5, "b", "Consultant B — don't take comments at face value"),
                        match_feature(56, "It will be some time before you start giving your employers their money's worth.", 5, "e", "Consultant E — 18 months before ROI"),
                    ],
                }
            ],
        },
...
print(f"Wrote {OUT} — {sum(len(p['questionGroups'][0]['questions']) for p in exam['parts'])} questions")