...
def cam10_t3_p4():
    return part(
        ...
        notePassage=[
            ...
            np_static("People's focus is to approach pleasure or avoid pain"),
            np_static("• Promotion goals focus on"), np_gap(31),
            np_static("• Prevention goals emphasise avoiding punishment"),
            np_section("Factors that affect people's focus"),
            np_section("The Chronic Factor"),
            np_static("• comes from one's"), np_gap(32),
            np_static("• The"), np_gap(33), np_static("Factor"),
            np_static("• we are more likely to focus on promotion goals when with a"), np_gap(34),
            np_static("• we are more likely to focus on prevention goals with our boss"),
            ...
            np_static("• Prevention Focus: People think about their 'ought' self and their obligations"),
            np_section("Leaders"),
            ...
            np_static("• inspire promotion focus in followers"),
            np_static("• Transactional Leaders: create"), np_gap(39),
            np_static("to make expectations clear"),
            np_static("• emphasise the results of a mistake"),
            np_static("• inspire prevention focus in followers"),
            np_section("Conclusion"),
            np_static("• Promotion Focus is good for jobs requiring"), np_gap(40),
            np_static("• Prevention Focus is good for work such as a surgeon"),
            np_static("• Leaders' actions affect which focus people use"),
        ],
    )
