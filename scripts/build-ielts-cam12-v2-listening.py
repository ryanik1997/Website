    ...
    return part(
        ...
        [
            mc(21, "James chose to take Scandinavian Studies because when he was a child", [
               ...
               sectionInstruction="Choose the correct letter, A, B or C.",
               sectionTitle="Scandinavian Studies"),
...
def cam12_t2_p4():
    return part(
        ...
        [
            ...
            gap(38, "A structure that is more …:", "democratic", sectionTitle="Other managers"),
    ...
    return part(
        ...
        [
            flow_match(21, labeled, letters, "C",
                       ...
                       sectionTitle="STAGES IN DOING A TOURISM CASE STUDY"),
            ...
            mc(27, "Natalie and Dave agree one reason why so few people visit Horton Castle is that", [
               ...
               sectionInstruction="Choose the correct letter, A, B or C.",
               sectionTitle="The Horton Castle site"),
...
def cam12_t4_p1():
    return part(
        ...
        [
            ...
            gap(7, "Address: 277 … Place:", "arbuthnot"),
        ...
        notePassage=[
            ...
            np_static("• address: 277"), np_gap(7), np_static("Place, Dumfries"),
