"""Create skills-inventory.xlsx with 3 sheets from the skills inventory data."""
...
category_font = Font(name="Arial", size=10, bold=True, color="2F5496")
category_fill = PatternFill(start_color="D6E4F0", end_color="D6E4F0", fill_type="solid")
claude_only_fill = PatternFill(start_color="FFF2CC", end_color="FFF2CC", fill_type="solid")
...
# ════════════════════════════════════════════
ws1 = wb.active
ws1.title = "All Skills"
ws1.append(["Skill Name", "Source", "Category"])
style_header(ws1, 3)

# Data: (skill_name, source, category)
skills = [
    # ── Anthropic Official ──
    ("anthropic-algorithmic-art", ".claude & .codex", "Anthropic Official"),
    ("anthropic-brand-guidelines", ".claude & .codex", "Anthropic Official"),
    ("anthropic-canvas-design", ".claude & .codex", "Anthropic Official"),
    ("anthropic-claude-api", ".claude & .codex", "Anthropic Official"),
    ("anthropic-doc-coauthoring", ".claude & .codex", "Anthropic Official"),
    ("anthropic-docx", ".claude & .codex", "Anthropic Official"),
    ("anthropic-frontend-design", ".claude & .codex", "Anthropic Official"),
    ("anthropic-internal-comms", ".claude & .codex", "Anthropic Official"),
    ("anthropic-mcp-builder", ".claude & .codex", "Anthropic Official"),
    ("anthropic-pdf", ".claude & .codex", "Anthropic Official"),
    ("anthropic-pptx", ".claude & .codex", "Anthropic Official"),
    ("anthropic-skill-creator", ".claude & .codex", "Anthropic Official"),
    ("anthropic-slack-gif-creator", ".claude & .codex", "Anthropic Official"),
    ("anthropic-theme-factory", ".claude & .codex", "Anthropic Official"),
    ("anthropic-web-artifacts-builder", ".claude & .codex", "Anthropic Official"),
    ("anthropic-webapp-testing", ".claude & .codex", "Anthropic Official"),
    ("anthropic-xlsx", ".claude & .codex", "Anthropic Official"),
    # ── Document / Office ──
    ("artifacts-builder", ".claude & .codex", "Document / Office"),
    ("awesome-docx", ".claude & .codex", "Document / Office"),
    ("awesome-pdf", ".claude & .codex", "Document / Office"),
    ("awesome-pptx", ".claude & .codex", "Document / Office"),
    ("awesome-xlsx", ".claude & .codex", "Document / Office"),
    # ── Brand / Design ──
    ("brand-guidelines", ".claude & .codex", "Brand / Design"),
    ("brandkit", ".claude only", "Brand / Design"),
    ("brutalist-skill", ".claude only", "Brand / Design"),
    ("canvas-design", ".claude & .codex", "Brand / Design"),
    ("redesign-skill", ".claude & .codex", "Brand / Design"),
    ("theme-factory", ".claude & .codex", "Brand / Design"),
    # ── Content / Marketing ──
    ("changelog-generator", ".claude & .codex", "Content / Marketing"),
    ("clone-website", ".claude only", "Content / Marketing"),
    ("competitive-ads-extractor", ".claude & .codex", "Content / Marketing"),
    ("content-research-writer", ".claude & .codex", "Content / Marketing"),
    ("image-enhancer", ".claude & .codex", "Content / Marketing"),
    ("image-to-code-skill", ".claude only", "Content / Marketing"),
    ("imagegen-frontend-mobile", ".claude only", "Content / Marketing"),
    ("imagegen-frontend-web", ".claude only", "Content / Marketing"),
    ("internal-comms", ".claude & .codex", "Content / Marketing"),
    ("lead-research-assistant", ".claude & .codex", "Content / Marketing"),
    ("meeting-insights-analyzer", ".claude & .codex", "Content / Marketing"),
    ("raffle-winner-picker", ".claude & .codex", "Content / Marketing"),
    ("tailored-resume-generator", ".claude & .codex", "Content / Marketing"),
    ("twitter-algorithm-optimizer", ".claude & .codex", "Content / Marketing"),
    # ── Connect ──
    ("connect", ".claude & .codex", "Connect"),
    ("connect-apps", ".claude & .codex", "Connect"),
    # ── Development / Growth ──
    ("developer-growth-analysis", ".claude & .codex", "Development / Growth"),
    ("domain-name-brainstormer", ".claude & .codex", "Development / Growth"),
    ("file-organizer", ".claude & .codex", "Development / Growth"),
    ("gpt-tasteskill", ".claude only", "Development / Growth"),
    ("invoice-organizer", ".claude & .codex", "Development / Growth"),
    ("langsmith-fetch", ".claude & .codex", "Development / Growth"),
    # ── i-have-adhd ──
    ("i-have-adhd", ".claude & .codex", "Output Style"),
    ("minimalist-skill", ".claude only", "Output Style"),
    ("output-skill", ".claude only", "Output Style"),
    ("soft-skill", ".claude only", "Output Style"),
    # ── Matt Pocock ──
    ("matt-ask-matt", ".claude & .codex", "Matt Pocock"),
    ("matt-batch-grill-me", ".claude & .codex", "Matt Pocock"),
    ("matt-claude-handoff", ".claude & .codex", "Matt Pocock"),
    ("matt-code-review", ".claude & .codex", "Matt Pocock"),
    ("matt-codebase-design", ".claude & .codex", "Matt Pocock"),
    ("matt-design-an-interface", ".claude & .codex", "Matt Pocock"),
    ("matt-diagnosing-bugs", ".claude & .codex", "Matt Pocock"),
    ("matt-domain-modeling", ".claude & .codex", "Matt Pocock"),
    ("matt-edit-article", ".claude & .codex", "Matt Pocock"),
    ("matt-git-guardrails-claude-code", ".claude & .codex", "Matt Pocock"),
    ("matt-grill-me", ".claude & .codex", "Matt Pocock"),
    ("matt-grill-with-docs", ".claude & .codex", "Matt Pocock"),
    ("matt-grilling", ".claude & .codex", "Matt Pocock"),
    ("matt-handoff", ".claude & .codex", "Matt Pocock"),
    ("matt-implement", ".claude & .codex", "Matt Pocock"),
    ("matt-improve-codebase-architecture", ".claude & .codex", "Matt Pocock"),
    ("matt-loop-me", ".claude & .codex", "Matt Pocock"),
    ("matt-migrate-to-shoehorn", ".claude & .codex", "Matt Pocock"),
    ("matt-obsidian-vault", ".claude & .codex", "Matt Pocock"),
    ("matt-prototype", ".claude & .codex", "Matt Pocock"),
    ("matt-qa", ".claude & .codex", "Matt Pocock"),
    ("matt-request-refactor-plan", ".claude & .codex", "Matt Pocock"),
    ("matt-research", ".claude & .codex", "Matt Pocock"),
    ("matt-resolving-merge-conflicts", ".claude & .codex", "Matt Pocock"),
    ("matt-scaffold-exercises", ".claude & .codex", "Matt Pocock"),
    ("matt-setup-matt-pocock-skills", ".claude & .codex", "Matt Pocock"),
    ("matt-setup-pre-commit", ".claude & .codex", "Matt Pocock"),
    ("matt-setup-ts-deep-modules", ".claude & .codex", "Matt Pocock"),
    ("matt-tdd", ".claude & .codex", "Matt Pocock"),
    ("matt-teach", ".claude & .codex", "Matt Pocock"),
    ("matt-to-questionnaire", ".claude & .codex", "Matt Pocock"),
    ("matt-to-spec", ".claude & .codex", "Matt Pocock"),
    ("matt-to-tickets", ".claude & .codex", "Matt Pocock"),
    ("matt-triage", ".claude & .codex", "Matt Pocock"),
    ("matt-ubiquitous-language", ".claude & .codex", "Matt Pocock"),
    ("matt-wayfinder", ".claude & .codex", "Matt Pocock"),
    ("matt-wizard", ".claude & .codex", "Matt Pocock"),
    ("matt-writing-beats", ".claude & .codex", "Matt Pocock"),
    ("matt-writing-fragments", ".claude & .codex", "Matt Pocock"),
    ("matt-writing-great-skills", ".claude & .codex", "Matt Pocock"),
    ("matt-writing-shape", ".claude & .codex", "Matt Pocock"),
    # ── MCP Builder ──
    ("mcp-builder", ".claude & .codex", "MCP Builder"),
    # ── Ponytail ──
    ("ponytail", ".claude & .codex", "Ponytail Suite"),
    ("ponytail-audit", ".claude & .codex", "Ponytail Suite"),
    ("ponytail-debt", ".claude & .codex", "Ponytail Suite"),
    ("ponytail-gain", ".claude & .codex", "Ponytail Suite"),
    ("ponytail-help", ".claude & .codex", "Ponytail Suite"),
    ("ponytail-review", ".claude & .codex", "Ponytail Suite"),
    # ── Skill Management ──
    ("skill-creator", ".claude & .codex", "Skill Management"),
    ("skill-share", ".claude & .codex", "Skill Management"),
    ("template-skill", ".claude & .codex", "Skill Management"),
    # ── Slack ──
    ("slack-gif-creator", ".claude & .codex", "Slack"),
    # ── Stitch ──
    ("stitch-build-react-components", ".claude & .codex", "Stitch"),
    ("stitch-build-react-native", ".claude & .codex", "Stitch"),
    ("stitch-build-react-vite-dashboard", ".claude & .codex", "Stitch"),
    ("stitch-build-remotion", ".claude & .codex", "Stitch"),
    ("stitch-build-shadcn-ui", ".claude & .codex", "Stitch"),
    ("stitch-design-code-to-design", ".claude & .codex", "Stitch"),
    ("stitch-design-extract-design-md", ".claude & .codex", "Stitch"),
    ("stitch-design-extract-static-html", ".claude & .codex", "Stitch"),
    ("stitch-design-generate-design", ".claude & .codex", "Stitch"),
    ("stitch-design-manage-design-system", ".claude & .codex", "Stitch"),
    ("stitch-design-upload-to-stitch", ".claude & .codex", "Stitch"),
    ("stitch-skill", ".claude only", "Stitch"),
    ("stitch-utilities-design-md", ".claude & .codex", "Stitch"),
    ("stitch-utilities-enhance-prompt", ".claude & .codex", "Stitch"),
    ("stitch-utilities-stitch-loop", ".claude & .codex", "Stitch"),
    ("stitch-utilities-taste-design", ".claude & .codex", "Stitch"),
    # ── Taste ──
    ("taste-skill", ".claude only", "Taste"),
    ("taste-skill-v1", ".claude only", "Taste"),
    # ── Turnstile / Video ──
    ("turnstile-spin", ".claude only", "Media"),
    ("video-downloader", ".claude only", "Media"),
    # ── Web App Testing ──
    ("webapp-testing", ".claude & .codex", "Web App Testing"),
]

# Add composio (summary rows)
composio_claude = [
...
# Write non-composio skills first
for name, source, category in skills:
    ws1.append([name, source, category])

# Write composio group header
ws1.append(["", "", ""])
ws1.append(["=== COMPOSIO AUTOMATIONS (" + str(len(composio_claude)) + " skills) ===", ".claude & .codex", "Composio"])
r = ws1.max_row
for c in range(1, 4):
...
# Write individual composio skills
for name in composio_claude:
    ws1.append([name, ".claude & .codex", "Composio"])

# Sheet 1 formatting
style_header(ws1, 3)
for row in range(2, ws1.max_row + 1):
    fill = claude_only_fill if ws1.cell(row=row, column=2).value == ".claude only" else None
    style_row(ws1, row, 3, fill=fill)

ws1.column_dimensions["A"].width = 52
ws1.column_dimensions["B"].width = 20
ws1.column_dimensions["C"].width = 22
ws1.auto_filter.ref = f"A1:C{ws1.max_row}"
ws1.freeze_panes = "A2"

# ════════════════════════════════════════════
# Sheet 2: Claude Only (15 skills)
# ════════════════════════════════════════════
ws2 = wb.create_sheet("Claude Only")
ws2.append(["Skill Name", "Category"])
style_header(ws2, 2)

claude_only = [
    ("brandkit", "Brand / Design"),
    ("brutalist-skill", "Brand / Design"),
    ("clone-website", "Content / Marketing"),
    ("gpt-tasteskill", "Development / Growth"),
    ("imagegen-frontend-mobile", "Content / Marketing"),
    ("imagegen-frontend-web", "Content / Marketing"),
    ("image-to-code-skill", "Content / Marketing"),
    ("minimalist-skill", "Output Style"),
    ("output-skill", "Output Style"),
    ("soft-skill", "Output Style"),
    ("stitch-skill", "Stitch"),
    ("taste-skill", "Taste"),
    ("taste-skill-v1", "Taste"),
    ("turnstile-spin", "Media"),
    ("video-downloader", "Media"),
]

for name, cat in claude_only:
    ws2.append([name, cat])
    style_row(ws2, ws2.max_row, 2, fill=claude_only_fill)
...
# Sheet 3: Built-in
# ════════════════════════════════════════════
ws3 = wb.create_sheet("Built-in")
ws3.append(["Skill Name", "Source"])
style_header(ws3, 2)
...
for name in builtin:
    ws3.append([name, "Claude Code Harness"])
...
# ── Save ──
output_path = "D:\\App-English-Ryan\\Website\\skills-inventory.xlsx"
wb.save(output_path)
print(f"Saved to {output_path}")
print(f"Sheet 1 'All Skills': {ws1.max_row - 1} rows")
print(f"Sheet 2 'Claude Only': {ws2.max_row - 1} rows")
print(f"Sheet 3 'Built-in': {ws3.max_row - 1} rows")
