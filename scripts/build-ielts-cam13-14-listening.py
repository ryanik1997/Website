            ...
            "rows": [
                ...
                {"cells": [
                    ...
                    [tbl_static("• small classes"),
                     ...
                     tbl_static(" discount"),
                     tbl_break(), tbl_static("• includes recipes to strengthen your "), tbl_gap(5),
    ...
    return part(
        ...
        [
            mc(11, "Why are changes needed to traffic systems in Granford?", [
               ...
               sectionTitle="Traffic Changes in Granford"),
...
def cam13_t1_p4():
    return part(
        ...
        notePassage=[
            ...
            np_static("Recent urban developments represent massive environmental changes."),
            np_static("It was previously thought that only a few animals were suitable for city life, e.g."),
            ...
            np_static("Species of animals may develop which are unique to cities."),
            np_static("However, some changes may not be "), np_gap(40),
        ],
    )
...
def cam13_t2_p1():
    return part(
        ...
        [
            ...
            gap(4, "Level 8: speed about … kph:", "25/twenty-five"),
        ...
        notePassage=[
            ...
            np_static("• Level 8: speed about"), np_gap(4), np_static("kph"),
    ...
    return part(
        ...
        [
            mc(11, "How much time for volunteering does the company allow per employee?", [
               ...
               sectionInstruction="Choose the correct letter, A, B or C.",
               sectionTitle="Information on company volunteering projects"),
    ...
    return part(
        ...
        [
            mc(21, "Russ says that his difficulty in planning the presentation is due to", [
               ...
               sectionInstruction="Choose the correct letter, A, B or C.",
               sectionTitle="Planning a presentation on nanotechnology"),
    ...
    return part(
        ...
        [
            match(11, "using a gym", list("ABCDEFG"), "F", labeled=adv_opts,
                  ...
                  sectionTitle="Physical activities"),
    ...
    return part(
        ...
        [
            mc(21, "What first inspired Jim to choose this project?", [
               ...
               sectionInstruction="Choose the correct letter, A, B or C.",
               sectionTitle="Project on using natural dyes to colour fabrics"),
...
def cam14_t1_p1():
    return part(
        ...
        notePassage=[
            ...
            np_section("Crime reference number allocated"),
            np_static("•"), np_gap(10),
        ],
    )
    ...
    return part(
        ...
        [
            *choose_two(11, 12,
                        ...
                        sectionInstruction="Choose TWO letters, A–E.",
                        sectionTitle="Induction talk for new apprentices"),
            *choose_two(13, 14,
...
def cam14_t2_p1():
    return part(
        ...
        "Complete the notes below. Write ONE WORD AND/OR A NUMBER for each answer.",
        [
            gap(1, "Contact phone:", "2194429785/219 442 9785", sectionTitle="TOTAL HEALTH CLINIC"),
        ...
        notePassage=[
            ...
            np_static("• Date of birth:"), np_gap(2),
            np_static("• Occupation: works as a"), np_gap(3),
            np_static("• Insurance company:"), np_gap(4),
            ...
            np_static("• injured her"), np_gap(9), np_static("last year"),
...
def cam14_t3_p1():
    return part(
        ...
        "Complete the notes below. Write ONE WORD AND/OR A NUMBER for each answer.",
        [
            gap(1, "the … room for talks:", "tesla", sectionTitle="Islanders conference"),
        ...
        notePassageLayout="form",
        notePassage=[
            np_example("Example\nCustomer Services Manager: Wilby"),
            np_static("Date available: weekend beginning February 4th"),
...
def cam14_t3_p4():
    return part(
        ...
        [
            ...
            gap(35, "The Tower of Remoteness is …:", "disturbing"),
        ...
        notePassage=[
            ...
            np_static("• The Tower of Remoteness is"), np_gap(35),
...
def cam14_t4_p1():
    ...
    return part(
        ...
        notePassage=[
            ...
            np_section("Accommodation:"),
            np_static("• in hotel rooms or"), np_gap(7),
        ],
    )
...
def cam14_t4_p4():
    return part(
        ...
        notePassage=[
            ...
            np_static("•"), np_gap(36), np_static("is used for short distance communication, acoustic waves for long distance"),
            np_static("• AUV can send data to another AUV that has better"), np_gap(37),
            np_section("Planned research in Gulf of Baratti"),
            np_static("• to find out more about wrecks of ancient Roman ships, including one carrying"), np_gap(38),
