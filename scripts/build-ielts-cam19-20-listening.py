...
CAM20_T1_P4_NOTE = [
    ...
    np_static("Over 2 billion passengers already travel by "), np_gap(38),
    np_static("Changes in shopping habits mean the number of deliveries that are made is increasing."),
    np_static("goods could be transported by large freight barges and electric "), np_gap(39),
...
def cam19_t1_p1():
    return part(
        ...
        notePassage=[
            np_section("Hinchingbrooke Country Park"),
            np_section("The park"),
        ...
        noteTables=[
            {
                ...
                "headers": ["Shop", "Details"],
                "rows": [
                    {"cells": [
                        [tbl_static("Where to go")],
                        [tbl_static("Kite Place — near the "), tbl_gap(1),
                         tbl_break(), tbl_static("Fish market"),
                         tbl_break(), tbl_static("cross the "), tbl_gap(2),
                         tbl_static(" and turn right"),
                         tbl_break(), tbl_static("best to go before "), tbl_gap(3), tbl_static(" pm")],
                    ]},
                    {"cells": [
                        [tbl_static("Organic shop")],
                        [tbl_static("called '"), tbl_gap(4), tbl_static("'"),
                         tbl_break(), tbl_static("below a restaurant in the large, grey building"),
                         tbl_break(), tbl_static("look for the large "), tbl_gap(5), tbl_static(" outside")],
                    ]},
                    {"cells": [
                        [tbl_static("Supermarket")],
                        [tbl_static("take a "), tbl_gap(6), tbl_static(" minibus, number 289")],
                    ]},
                ],
            },
            {
...
def cam19_t4_p1():
    return part(
        ...
        [
            ...
            gap(2, "use … in staffroom:", "locker", "Tủ khóa.", word_limit=2),
            ...
            gap(7, "Bakery — use … labels:", "yellow", "Màu vàng.", word_limit=1,
                sectionRange="Questions 7 – 10",
                sectionInstruction="Complete the table below. Write ONE WORD ONLY for each answer."),
            gap(8, "Sushi — do not clean … and clean the sink:", "plastic", "Nhựa.", word_limit=1),
        ...
        noteTables=[
            {
                ...
                "rows": [
                    {"cells": [[tbl_static("Name of supervisor")], [tbl_gap(1)]]},
                    {"cells": [[tbl_static("Where to leave coat and bag")],
                               [tbl_static("use "), tbl_gap(2), tbl_static(" in staffroom")]]},
                    {"cells": [[tbl_static("See Tiffany in HR")],
                               [tbl_static("to give "), tbl_gap(3), tbl_static(" number"),
                                tbl_break(), tbl_static("to collect "), tbl_gap(4)]]},
                    {"cells": [[tbl_static("Location of HR office")],
                               [tbl_static("on "), tbl_gap(5), tbl_static(" floor")]]},
                    {"cells": [[tbl_static("Supervisor's mobile number")], [tbl_gap(6)]]},
                ],
            },
            {
                "gapNumbers": [7, 8, 9, 10],
                "instruction": "Questions 7 – 10\nComplete the table below. Write ONE WORD ONLY for each answer.",
                "headers": ["Section", "Task 1", "Task 2", "Notes"],
                "rows": [
                    {"cells": [
                    ...
                    {"cells": [
                        [tbl_static("Sushi takeaway")],
                        [tbl_static("Re-stock with boxes if needed")],
                        [tbl_static("Wipe preparation area")],
                        [tbl_static("Do not clean "), tbl_gap(8), tbl_static(" and clean the sink")],
                    ]},
                    {"cells": [
...
def cam19_t4_p4():
    return part(
        ...
        notePassage=[
            np_section("Tree planting"),
            np_static("Reforestation projects should:"),
            ...
            np_static("increasing the "), np_gap(37), np_static(" of recovery by attracting animals and birds, e.g., "),
            np_gap(38), np_static(" were soon attracted to the area."),
...
def cam20_t1_p4():
    return part(
        ...
        [
            ...
            gap(38, "Passengers travel by:", "ferry", "Phà.", word_limit=1),
    ...
    return part(
        ...
        [
            gap(1, "time for other responsibilities — a …:", "break", "Giờ nghỉ.", word_limit=1,
                sectionTitle="Local councils — practical support for carers"),
    ...
    return part(
        ...
        [
            gap(31, "growth in interest started with … of food on social media:", "photos", "Ảnh.", word_limit=1,
                sectionTitle="Developing food trends"),
        ...
        notePassage=[
            np_section("Developing food trends"),
...
CAM20_T3_P1_TABLE = {
    ...
    "rows": [
        ...
        {"cells": [
            ...
            [tbl_static("12% monthly fee for "), tbl_gap(5),
             tbl_break(), tbl_static("Also offers a cleaning service")],
        ]},
        {"cells": [
            ...
            [tbl_static("Must have own "), tbl_gap(7),
             tbl_break(), tbl_static("Must have enough "), tbl_gap(8),
             tbl_break(), tbl_static("Minimum contract length: six months")],
        ]},
        {"cells": [
            [tbl_static("8 Rentals")],
...
def cam20_t3_p1():
    return part(
        ...
        [
            ...
            gap(8, "must have enough …:", "space", "Không gian.", word_limit=2),
...
def cam20_t3_p4():
    return part(
        ...
        notePassage=[
            ...
            np_static("To assist the elderly:"),
            ...
            np_static("Access — Loss of independence for disabled people."),
            np_static("Safety — Seatbelts are especially problematic for "), np_gap(37), np_static(" women."),
            ...
            np_static("Comfort in the workplace — The "), np_gap(40), np_static(" in offices is often too low for women."),
        ],
    )
...
def cam20_t4_p1():
    return part(
        ...
        notePassageLayout="form",
        notePassage=[
            np_section("Advice on family visit"),
            ...
            np_section("Food"),
            np_static("Clacton Market:"),
            np_static("– good for "), np_gap(7),
...
def cam20_t4_p4():
    return part(
        ...
        notePassage=[
            np_section("Research in the area around Chembe Bird Sanctuary"),
            ...
            np_static("The birds may be accidentally killed by "), np_gap(34), np_static(" when they are hunting or sleeping"),
