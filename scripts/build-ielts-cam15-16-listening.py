...
def cam15_t1_p2():
    return part(
        ...
        [
            ...
            gap(19, "Take the … railway:", "steam", word_limit=1),
            gap(20, "Former … has old castle:", "capital", word_limit=1),
        ],
        ...
        noteTables=[{
            ...
            "rows": [
                {"cells": [
                    [tbl_static("Day 1 — Arrive")],
                    [tbl_static("Hotel dining room has view of the "), tbl_gap(15)],
                ]},
                {"cells": [
                    [tbl_static("Day 2 — Tynwald Exhibition and Peel")],
                    [tbl_static("Tynwald may have been founded in "), tbl_gap(16),
                     tbl_static(" not 979")],
                ]},
                {"cells": [
                    [tbl_static("Day 3 — Trip to Snaefell")],
                    [tbl_static("Travel along promenade in a tram; train to Laxey; train to the "),
                     tbl_gap(17), tbl_static(" of Snaefell")],
                ]},
                {"cells": [
                    [tbl_static("Day 4 — Free day")],
                    [tbl_static("Company provides a "), tbl_gap(18),
                     tbl_static(" for local transport and heritage sites")],
                ]},
                {"cells": [
                    [tbl_static("Day 5")],
                    [tbl_static("Take the "), tbl_gap(19), tbl_static(" railway"),
                     tbl_break(), tbl_static("former "), tbl_gap(20), tbl_static(" has old castle")],
                ]},
                {"cells": [
                    [tbl_static("Day 6 — Leave")],
...
def cam15_t1_p4():
    return part(
        ...
        notePassage=[
            ...
            np_static("• high-frequency bushfires have impact on vegetation, resulting in the growth of "), np_gap(35),
    ...
    return part(
        ...
        noteTables=[
            ...
            },
            {
                ...
                "title": "Workshops and outdoor activities",
                "headers": ["Section", "Details"],
                "rows": [
                    {"cells": [
                        [tbl_static("Workshops")],
                        [tbl_static("Making "), tbl_gap(5), tbl_static(" food"),
                         tbl_break(), tbl_static("(children only) Making "), tbl_gap(6),
                         tbl_break(), tbl_static("(adults only) Making toys from "), tbl_gap(7),
                         tbl_static(" using various tools")],
                    ]},
                    {"cells": [
                        [tbl_static("Outdoor activities")],
                        [tbl_static("Swimming in the "), tbl_gap(8),
                         tbl_break(), tbl_static("Walking in the woods, led by an expert on "), tbl_gap(9),
                         tbl_break(), tbl_static("See the festival organiser's "), tbl_gap(10),
                         tbl_static(" for more information")],
                    ]},
                ],
            },
        ],
    ...
    return part(
        ...
        [
            ...
            gap(30, "… the research:", "evaluate", word_limit=1,
                ...
                flowChartEnd="Evaluate the research."),
        ],
    )
