...
export const IELTS_P1_READING_TEMPLATE_OPTIONS: IeltsReadingTemplateOption[] = [
  ...
  {
    kind: 'p1-r1-tfng-table',
    code: 'r1tb',
    label: 'TFNG + Table',
    description: 'TFNG Q1–6 + table completion Q7–13 (noteTable n cột × m dòng, merge ô) — Cam (Rocha bat study).',
    previewUrl: '/ielts-wizard/reading/p1/Teamplate_Part1_10.jpg',
  },
  {
    kind: 'p1-r1-sentence-table-tfng',
    code: 'r1st',
    label: 'Sentence + Table + TFNG',
    description: 'Sentence completion Q1–3 (TWO WORDS AND/OR A NUMBER) + table Q4–7 (ONE WORD AND/OR A NUMBER, noteTable 4 cột) + TFNG Q8–13 — Cam (Aeroponic urban farming).',
    previewUrl: '/ielts-wizard/reading/p1/Teamplate_Part1_11.jpg',
  },
  {
    kind: 'p1-r1-match-summary-features',
    code: 'r1msf',
    label: 'Match đoạn + Summary + Features',
    description: 'Which section Q1–4 (A–H) + summary ONE WORD Q5–8 (note inline) + matching features A–D Q9–13 — Cam (Making buildings with wood).',
    previewUrl: '/ielts-wizard/reading/p1/Teamplate_Part1_12.jpg',
  },
  {
    kind: 'p1-r1-match-summary-choose-two',
    code: 'r1ms2',
    label: 'Match đoạn + Summary + Choose TWO',
    description: 'Which section Q1–5 (A–E) + summary ONE WORD Q6–9 (note) + Choose TWO Q10–11 (A–E) + MC Q12–13 — Cam (Green roofs).',
    previewUrl: '/ielts-wizard/reading/p1/Teamplate_Part1_13.jpg',
  },
  {
    kind: 'p1-r1-tfng-notes',
    code: 'r1tn',
    label: 'TFNG + Notes',
    description: 'TFNG Q1–7 + note completion Q8–13 (notePassage, ONE WORD ONLY) — Cam (tennis racket / Teamplate_Part1_14.jpg).',
    previewUrl: '/ielts-wizard/reading/p1/Teamplate_Part1_14.jpg',
  },
]
...
export const IELTS_P2_READING_TEMPLATE_OPTIONS: IeltsReadingTemplateOption[] = [
  ...
  {
    kind: 'p2-r2-match-features-sentence',
    code: 'r2mfs',
    label: 'Match đoạn + Features + Sentence',
    description: 'Which section Q14–18 (A–G) + matching features Q19–21 (A–C cuts) + sentence ONE WORD Q22–26 — Cam (Forest management / TSI, Salvage, Shelterwood).',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_13.jpg',
  },
  {
    kind: 'p2-r2-mc-ynng-summary',
    code: 'r2mys',
    label: 'MC + YNNG + Summary bank',
    description: 'Multiple choice A–D Q14–19 + YNNG Q20–23 (claims of writer) + summary word bank A–F Q24–26 — Cam (AI / UK health system).',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_14.jpg',
  },
  {
    kind: 'p2-r2-headings-mc-summary',
    code: 'r2hmc',
    label: 'Headings + MC + Summary',
    description: 'Matching headings Q14–20 (A–G, i–viii) + MC A–D Q21–23 + summary ONE WORD AND/OR A NUMBER Q24–26 (note) — Cam (Steam car / Model E).',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_15.jpg',
  },
  {
    kind: 'p2-r2-mc-features-ynng',
    code: 'r2mfy',
    label: 'MC + Features + YNNG',
    description: 'Multiple choice A–D Q14–16 + matching features A–E Q17–22 + YNNG Q23–26 (claims of writer) — Cam (Growth mindset / Dweck, Binet…).',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_16.jpg',
  },
  {
    kind: 'p2-r2-match-sentence-choose-two',
    code: 'r2msc',
    label: 'Match đoạn + Sentence + Choose TWO',
    description: 'Which section Q14–18 (A–F) + sentence ONE WORD Q19–22 + 2× Choose TWO A–E Q23–26 — Cam19 T2 P2 (Athletes and stress).',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_17.jpg',
  },
  {
    kind: 'p2-r2-match-sentence-features',
    code: 'r2msf',
    label: 'Match đoạn + Sentence + Features',
    description: 'Which section Q14–17 (A–H) + sentence ONE WORD Q18–22 + matching features A–D Q23–26 — Cam19 T3 P2 (Wetlands / peatlands).',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_18.jpg',
  },
  {
    kind: 'p2-r2-match-features-summary',
    code: 'r2mfu',
    label: 'Match đoạn + Features + Summary',
    description: 'Which section Q14–17 (A–F) + matching features A–E Q18–23 + summary ONE WORD Q24–26 — Cam19 T4 P2 (Deep-sea mining).',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_19.jpg',
  },
  {
    kind: 'p2-r2-match-summary-choose-two',
    code: 'r2ms2',
    label: 'Match đoạn + Summary + Choose TWO',
    description: 'Which section Q14–16 + summary ONE WORD Q17–22 (note) + Choose TWO A–E Q23–24 + Choose TWO A–E Q25–26.',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_10.jpg',
  },
  {
    kind: 'p2-r2-headings-choose-two-notes',
    code: 'r2h2n',
    label: 'Headings + Choose TWO + Notes',
    description: 'Headings Q14–19 (A–F, i–vii) + Choose TWO A–E Q20–21 + Choose TWO A–E Q22–23 + notes ONE WORD Q24–26 — coral reefs (Teamplate_Part2_20).',
    previewUrl: '/ielts-wizard/reading/p2/Teamplate_Part2_20.jpg',
  },
]
...
export const IELTS_P3_READING_TEMPLATE_OPTIONS: IeltsReadingTemplateOption[] = [
  ...
  },
  {
    ...
    code: 'r3my',
    label: 'MC + Summary bank + YNNG',
    description: 'MC A–D Q27–30 + summary word bank A–J Q31–36 (LIST OF OPTIONS) + YNNG Q37–40 — Cam19 Test 1 P3 (misinformation). Khác r3ysm (YNNG trước).',
  ...
  {
    kind: 'p3-r3-match-summary-features',
    code: 'r3ms',
    label: 'Match đoạn + Summary + Features',
    description: 'Matching paragraph Q27–31 (A–F) + summary ONE WORD Q32–35 (note inline) + matching features Q36–40 (người A–D) — Cam (Space debris / Frueh, Krag…).',
    previewUrl: '/ielts-wizard/reading/p3/Teamplate_Part3_13.jpg',
  },
  {
    kind: 'p3-r3-ynng-summary-mc',
    code: 'r3ysm',
    label: 'YNNG + Summary bank + MC',
    description: 'YNNG Q27–30 (claims of writer) + summary word bank A–J Q31–36 + MC A–D Q37–40 — Cam (Wegener / continental drift).',
    previewUrl: '/ielts-wizard/reading/p3/Teamplate_Part3_14.jpg',
  },
  {
    kind: 'p3-r3-summary-bank-ynng-mc',
    code: 'r3sb',
    label: 'Summary bank + YNNG + MC',
    description: 'Summary word bank A–K Q27–32 + YNNG Q33–37 (claims of writer) + MC A–D Q38–40 — Cam19 T2 P3 (gifted child / Mirzakhani).',
    previewUrl: '/ielts-wizard/reading/p3/Teamplate_Part3_15.jpg',
  },
  {
    kind: 'p3-r3-mc-endings-ynng',
    code: 'r3mey',
    label: 'MC + Endings + YNNG',
    description: 'MC A–D Q27–30 + sentence endings A–F Q31–34 + YNNG Q35–40 (views of writer) — Cam19 T3 P3 (artificial speech translation).',
    previewUrl: '/ielts-wizard/reading/p3/Teamplate_Part3_16.jpg',
  },
  {
    kind: 'p3-r3-mc-summary-gap-ynng',
    code: 'r3mgy',
    label: 'MC + Summary ONE WORD + YNNG',
    description: 'MC A–D Q27–30 + summary ONE WORD ONLY Q31–35 (note, no bank) + YNNG Q36–40 — Cam19 T4 P3 (The Unselfish Gene / hunter-gatherers).',
    previewUrl: '/ielts-wizard/reading/p3/Teamplate_Part3_17.jpg',
  },
  {
    kind: 'p3-r3-ynng-summary-bank-mc',
    code: 'r3ysb',
    label: 'YNNG 6 + bank 5 + MC 3',
    description: 'YNNG Q27–32 (claims of writer) + summary word bank A–H Q33–37 (Calls by the umpire) + MC A–D Q38–40 — ABS baseball (Teamplate_Part3_18). Khác r3ysm (4 YNNG + 6 bank + 4 MC).',
    previewUrl: '/ielts-wizard/reading/p3/Teamplate_Part3_18.jpg',
  },
  {
    kind: 'p3-r3-features-endings-mc',
    code: 'r3fem',
    label: 'Features + Endings + MC',
    description: 'Matching features A–C Q27–33 (people) + sentence endings A–D Q34–36 + MC A–D Q37–40 — robots / Rees–Wolpert–Richardson (Teamplate_Part3_19).',
    previewUrl: '/ielts-wizard/reading/p3/Teamplate_Part3_19.jpg',
  },
  {
    kind: 'p3-r3-match-features-summary',
    code: 'r3mfs',
    label: 'Match đoạn + Features + Summary',
    description: 'Which section Q27–31 (A–G) + matching features A–E Q32–36 (people) + summary ONE WORD Q37–40 — livestock guard dogs (Teamplate_Part3_20). Khác r3ms (summary giữa, features cuối).',
    previewUrl: '/ielts-wizard/reading/p3/Teamplate_Part3_20.jpg',
  },
]
