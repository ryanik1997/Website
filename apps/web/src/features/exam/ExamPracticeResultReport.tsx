...
function ResultSun() {
  return (
    <svg className="exam-practice-result__sun" viewBox="0 0 120 120" aria-hidden>
      <defs>
        <radialGradient id="epr-sun-grad" cx="40%" cy="35%" r="65%">
      ...
      <circle cx="60" cy="60" r="34" fill="url(#epr-sun-grad)" />
