            ...
            >
              <div className="login-card__field-group">
                ...
                <div className="login-card__input">
                  <span className="login-card__input-icon" aria-hidden>@</span>
                  <input
                    id="login-email"
                    name="email"
                    type="email"
              ...
              <div className="login-card__field-group">
                ...
                <div className="login-card__input login-card__input--password">
                  <span className="login-card__input-icon" aria-hidden>
                  ...
                  <button
                    type="button"
                    className="login-card__input-toggle"
