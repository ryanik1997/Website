...
const EXTRA: Partial<Record<Language, Record<string, string>>> = {
  vi: {
    ...
    'nav.readingCorner': 'Góc đọc', 'nav.readingBao': 'Đọc Báo Song Ngữ', 'nav.readingSach': 'Đọc Sách Song Ngữ', 'nav.speakingAi': 'Speaking AI', 'nav.speakingIelts': 'Speaking IELTS',
  ...
  en: {
    ...
    'nav.readingCorner': 'Reading corner', 'nav.readingBao': 'Bilingual news', 'nav.readingSach': 'Bilingual books', 'nav.speakingAi': 'Speaking AI', 'nav.speakingIelts': 'Speaking IELTS',
