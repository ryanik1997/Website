...
export type Feature =
  ...
  | 'writing_ai' | 'mindmap_ai' | 'dictionary_ai' | 'ai_router'
  | 'all'

const PLAN_FEATURES: Record<Plan, Feature[]> = {
  free:     ['sentence_patterns', 'vocab_basic', 'settings'],
  trial:    ['sentence_patterns', 'vocab_basic', 'settings', 'vocab_srs', 'review_reminder', 'writing_ai', 'mindmap_ai', 'dictionary_ai', 'backup', 'export'],
  basic:    ['sentence_patterns', 'vocab_basic', 'settings', 'vocab_srs', 'review_reminder', 'backup', 'export'],
  pro:      ['sentence_patterns', 'vocab_basic', 'settings', 'vocab_srs', 'review_reminder', 'backup', 'export', 'writing_ai', 'mindmap_ai', 'dictionary_ai', 'ai_router'],
  lifetime: ['all'],
}
