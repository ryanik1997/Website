...
Export **Microsoft Clarity** user behavior analytics directly from Codex. Pull heatmap data, session metrics, and engagement insights segmented by multiple dimensions without leaving your terminal.
